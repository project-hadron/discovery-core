...
from ds_core.intent.python_cleaners_intent import PythonCleanersIntentModel as ControlIntentModel
...
class ControlComponent(AbstractComponent):
    ...
    DEFAULT_MODULE = 'test.handlers.pyarrow_handlers'
    ...
    def from_uri(cls, task_name: str, uri_pm_path: str, creator: str, uri_pm_repo: str=None, pm_file_type: str=None,
        ...
        pm_module = pm_module if isinstance(pm_module, str) else 'test.handlers.pyarrow_handlers'
...
class AbstractComponentTest(unittest.TestCase):
    ...
    def test_report_connectors(self):
        ...
        control = ['test.handlers.pyarrow_handlers']*3
    ...
    def test_PM_from_env(self):
        ...
        os.environ['HADRON_PM_TYPE'] = 'json'
        os.environ['HADRON_PM_MODULE'] = 'test.handlers.pyarrow_handlers'
        ...
        self.assertEqual('test.handlers.pyarrow_handlers', result.module_name)
    ...
    def test_DEFAULT_from_env(self):
        ...
        self.assertEqual('test.handlers.pyarrow_handlers', source.module_name)
        ...
        self.assertEqual('test.handlers.pyarrow_handlers', persist.module_name)
        self.assertDictEqual({}, persist.kwargs)
        os.environ['HADRON_DEFAULT_PATH'] = "HADRON_CONTROL_PATH?C=24&B=fred"
        os.environ['HADRON_DEFAULT_MODULE'] = "test.handlers.pyarrow_handlers"
        os.environ['HADRON_DEFAULT_SOURCE_HANDLER'] = "PythonSourceHandler"
        os.environ['HADRON_DEFAULT_PERSIST_HANDLER'] = "PythonPersistHandler"
        instance = ControlComponent.from_env('task', has_contract=False)
        source = instance.pm.get_connector_contract(instance.pm.TEMPLATE_SOURCE)
    ...
    def test_from_environ(self):
        ...
        os.environ['MODULE'] = 'test.handlers.pyarrow_handlers'
        ...
        self.assertEqual("test.handlers.pyarrow_handlers", cc.module_name)
    ...
    def test_default_connector(self):
        ...
        self.assertEqual('test.handlers.pyarrow_handlers', connector.module_name)
